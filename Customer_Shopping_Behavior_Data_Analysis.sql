...
-- Q2. Which customers used a discount and but still spend more than the average purchase amount?
...
SELECT customer_segment, COUNT(*) AS customer_count FROM customer_type
...
SELECT age_group, SUM(purchase_amount) AS Total_Spending FROM customer
GROUP BY age_group
